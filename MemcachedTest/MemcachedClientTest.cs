...
namespace MemcachedTest
{
    ...
    public class MemcachedClientTest
    {
        ...
        public void ProgrammaticConfigurationTest()
        {
            ...
            mcc.Servers.Add(new IPEndPoint(IPAddress.Loopback, 20000));
            mcc.Servers.Add(new IPEndPoint(IPAddress.Loopback, 20002));
        ...
        {
            TestData td = new TestData { FieldA = "Hello", FieldB = "World", FieldC = 19810619, FieldD = true };
