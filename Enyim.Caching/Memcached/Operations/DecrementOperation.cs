...
namespace Enyim.Caching.Memcached.Operations
{
    internal sealed class DecrementOperation : ItemOperation
    {
        ...
        protected override bool ExecuteAction()
        {
            ...
            socket.SendCommand(String.Concat("decr ", HashedKey, " ", amount.ToString(CultureInfo.InvariantCulture)));
            ...
            return UInt32.TryParse(response, NumberStyles.AllowLeadingWhite | NumberStyles.AllowTrailingWhite, CultureInfo.InvariantCulture, out result);
        }
