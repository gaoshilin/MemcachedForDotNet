...
namespace Enyim.Caching.Configuration
{
    ...
    public sealed class EndPointElement : ConfigurationElement
    {
        ...
        /// </summary>
        [ConfigurationProperty("address", IsRequired = true, IsKey = true), ConfigurationValidator(typeof(IPAddressValidator))]
        ...
        {
            get { return (endpoint ?? (endpoint = new System.Net.IPEndPoint(System.Net.IPAddress.Parse(Address), Port))); }
        }
